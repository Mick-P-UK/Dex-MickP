...
if (-not (Test-Path ".git")) {
    git init
    Write-Host "[x] Git repository initialized" -ForegroundColor Green
} else {
    Write-Host "[x] Git repository already exists" -ForegroundColor Yellow
}
...
Write-Host "[x] Files staged" -ForegroundColor Green
...
Write-Host "[x] Initial commit created" -ForegroundColor Green
