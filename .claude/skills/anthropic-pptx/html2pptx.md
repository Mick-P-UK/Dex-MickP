...
- [x] Correct: `<div><p>Text here</p></div>`
...
- [x] Web-safe fonts: `Arial`, `Helvetica`, `Times New Roman`, `Georgia`, `Courier New`, `Verdana`, `Tahoma`, `Trebuchet MS`, `Impact`, `Comic Sans MS`
...
- [x] Correct: `color: "FF0000"`, `fill: { color: "0066CC" }`
