...
if [ "$NODE_VERSION" -ge 20 ]; then
  VITE_VERSION="latest"
  echo "[x] Using Vite latest (Node 20+)"
else
  VITE_VERSION="5.4.11"
  echo "[x] Using Vite $VITE_VERSION (Node 18 compatible)"
fi
...
echo "[x] Setup complete! You can now use Tailwind CSS and shadcn/ui in your project."
echo ""
