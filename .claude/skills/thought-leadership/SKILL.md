...
| **Actionable** | Reader knows exactly what to DO | "Create a file called voice-dna-mick.json in your context folder" |
...
- [ ] Sounds like the user (verified against voice-dna-mick.json)
...
- Use your language patterns (check voice-dna-mick.json)
